...
for issue in issue_events:
    print("Vulnerability Name:"+issue['issue']['name']+",""Severity:"+issue['issue']['severity']+",""Origin:" +
          issue['issue']['origin']+",""Path:"+issue['issue']['path']+",""Confidence:"+issue['issue']['confidence'])
